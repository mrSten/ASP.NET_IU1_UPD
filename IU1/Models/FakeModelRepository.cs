...
namespace IU1.Models
{
  ...
  //Fake databas
  public class FakeModelRepository : IFakeDataRepository
  {
    ...
    public IEnumerable<Status> Statuses => new List<Status>
    {
        new Status
        {
          StatusID = "1", StatusName = "Rapporterad"
        },new Status
        {
          StatusID = "2", StatusName = "Ingen åtgärd"
        },
        new Status
        {
          StatusID = "3", StatusName = "Startad"
        },
        new Status
        {
          StatusID = "4", StatusName = "Färdig"
        }
    ...
    public IEnumerable<Department> Departments => new List<Department> {
      new Department
      {
        DepartmentID = "1", DepartmentName = "Småstads Kommun"
      },
      new Department
      {
        DepartmentID = "2", DepartmentName = "IT-avdelningen"
      },
      new Department
      {
        DepartmentID = "3", DepartmentName = "Lek och Skoj"
      },
      new Department
      {
        DepartmentID = "4", DepartmentName = "Miljöskydd"
      }
    };
    ...
    public IEnumerable<Employee> Employees => new List<Employee> {
      new Employee
      {
        EmployeeID = "1", EmployeeName = "Martin Kvist", Department = "Småstads Kommun", RoleTitle = "Citizen"
      },
      new Employee
      {
        EmployeeID = "2", EmployeeName = "Lena Larsson", Department = "IT-avdelningen", RoleTitle = "Coordinator"
      },
      new Employee
      {
        EmployeeID = "3", EmployeeName = "Oskar Ivarsson", Department = "Lek och Skoj", RoleTitle = "Investigator"
      },
      new Employee
      {
        EmployeeID = "4", EmployeeName = "Susanne Fred", Department = "Miljöskydd", RoleTitle = "Manager"
      }
    };
